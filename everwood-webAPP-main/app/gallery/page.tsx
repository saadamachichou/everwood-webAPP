    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Dark scrim — gallery dimming (replaces light wash on the photo) */}
          <div
            style={{
              position: "absolute",
              inset: 0,
              margin: 0,
              background: `linear-gradient(120deg, rgba(10,8,5,0.52) 0%, rgba(26,34,51,0.34) 42%, rgba(10,8,5,0.28) 100%)`,
              pointerEvents: "none",
            }}
          />
        ...
        {/* Extra read legibility on the left — lighter now that the hero uses a dark scrim */}
        <div
          aria-hidden="true"
          style={{
            position: "absolute",
            ...
            pointerEvents: "none",
            background: `linear-gradient(to right, rgba(10,8,5,0.14) 0%, rgba(10,8,5,0.05) 55%, transparent 100%)`,
            zIndex: 1,
          }}
        />

        {/* Top band — extra dim under fixed navbar (full width, fades by mid-hero) */}
        <div
          aria-hidden="true"
          style={{
            position: "absolute",
